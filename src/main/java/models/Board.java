...
public class Board {
    ...
    public Board() {
        ...
        field[5] = new Shipping("Øresund", 200, 25, Color.WHITE);
        ...
        field[15] = new Shipping("D.F.D.S.", 200,25, Color.WHITE);
        ...
        field[25] = new Shipping("Ø.S.", 200,25, Color.WHITE);
        ...
        field[31] = new Street("Amagertorv", 300, 25, Color.YELLOW);
        ...
        field[35] = new Shipping("Bornholm", 200,25, Color.WHITE);
